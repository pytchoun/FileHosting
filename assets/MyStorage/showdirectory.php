...
if ($idFolder != 0) { ?>
  <div class="row">
    <div class="col-md-2">
      <p>
        <button type="button" class="btn btn-teal btn-block" onclick="showDirectory(<?php echo $myFolderParent['id_folder']; ?>)"><i class="fas fa-long-arrow-alt-left"></i> Retour au dossier parent</button>
      </p>
    </div>
  </div>
<?php } ?>
