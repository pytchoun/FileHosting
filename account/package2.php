...
if (isset($_POST['pay-subscription'])) {
  payPackage(6, 12, 107374182400);
}
if (isset($_POST['pay-subscription-with-new-payment'])) {
  payPackageWithNewPayment(6, 12, 107374182400);
}
...
<body>
  <section>
    <div class="container">
      ...
      <?php
      if ($status[0] > $beginPackage AND $status[1] == "Package 2") { ?>
        <div class="row">
          <div class="col-md-12">
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td>Package 2</td>
                  <td>1 mois</td>
                  <td>12€<span class="text-muted">/mois TTC</span></td>
                </tr>
              </tbody>
            </table>
          </div>
