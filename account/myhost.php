...
<body>
  <section>
    <div class="container-fluid">
      <div class="row my-5">
        <div class="col-md-12">
          <h1 class="text-center">Mon espace de stockage : Mes fichiers partagés</h1>
        </div>
        <div class="col-md-12">
                    ...
                    <tbody>
                      ...
                      foreach ($folderResult as $key => $folderShared) { ?>
                        <tr>
                          ...
                          <td><?php echo $folderShared['email']; ?></td>
                          <td></td>
                          <td></td>
                          <td>
                      ...
                      foreach ($fileResult as $row => $fileShared) {
                        ...
                        <tr>
                          ...
                          <td><?php echo $fileShared['email']; ?></td>
